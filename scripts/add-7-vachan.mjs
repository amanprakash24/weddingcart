  ...
  packages: [
    {
      ...
      price: 1100,
      isPerPlate: true,
      features: ['₹1,100 per plate', 'Full Veg Menu', 'In-House Catering', 'Hall + Décor Included'],
      isPopular: false,
    },
    {
      id: 'non-veg',
      ...
      price: 1300,
      isPerPlate: true,
      features: ['₹1,300 per plate', 'Veg + Non-Veg Menu', 'In-House Catering', 'Hall + Décor Included'],
      isPopular: true,
    },
  ],
  isFeatured: true,
