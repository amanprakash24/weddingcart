    ...
    <div>
      ...
      <section className="py-16 sm:py-24 bg-[#F8F5EF] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            className="text-center mb-10 sm:mb-14"
            initial="hidden" whileInView="show" viewport={{ once: true, margin: '-60px' }} variants={stagger(0.12)}
          >
            <motion.p variants={fadeUp} className="eyebrow-luxury mb-3">Your City. Your Wedding.</motion.p>
            <motion.h2 variants={fadeUp} className="text-3xl sm:text-5xl font-semibold text-[#2A1F1B] leading-tight" style={{ fontFamily: 'var(--font-playfair, serif)' }}>
          ...
          <motion.div
            ...
            initial="hidden" whileInView="show" viewport={{ once: true, margin: '-40px' }} variants={stagger(0.08)}
          >
            ...
            <motion.div variants={fadeUp} className="lg:w-[38%] flex-shrink-0">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  ...
                  <h3 className="text-white text-2xl sm:text-3xl font-bold mb-2 leading-tight" style={{ fontFamily: 'var(--font-playfair, serif)' }}>
                ...
                <motion.div key={slug} variants={fadeUp}>
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-3">
                      <p className="text-white text-sm font-semibold leading-tight" style={{ fontFamily: 'var(--font-playfair, serif)' }}>
                        {name}
                      </p>
                    </div>
                  </Link>
