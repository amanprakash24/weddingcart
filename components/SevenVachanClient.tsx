...
const FEATURES = [
  ...
  '500+ Guests Capacity',
  'U-Shape & Indoor Seating',
  'Baby Shower, Birthday, Weddings & More',
  'Established 2016 — 10 Years in Business',
];

const BADGES = [
  { icon: Users, label: '500+ Guests' },
  { icon: Home, label: '7 Guest Rooms' },
  { icon: Music, label: 'In-House DJ' },
...
const GALLERY = [
  {
    ...
    alt: '7 Vachan banquet hall illuminated at night — Judges Colony Patna',
  },
  {
    src: 'https://content.jdmagicbox.com/v2/comp/patna/z3/0612px612.x612.250508092933.e8z3/catalogue/7-vachan-judges-colony-patna-banquet-halls-8m6z2kwjts.jpg',
    alt: 'Red and gold wedding aisle at 7 Vachan, Patna',
  },
  {
    src: 'https://content.jdmagicbox.com/v2/comp/patna/z3/0612px612.x612.250508092933.e8z3/catalogue/7-vachan-judges-colony-patna-banquet-halls-qph2udv4ww.jpg',
    alt: '7 Vachan event hall with red carpet and decorated chairs, Patna',
  },
  {
    src: 'https://content.jdmagicbox.com/v2/comp/patna/z3/0612px612.x612.250508092933.e8z3/catalogue/7-vachan-judges-colony-patna-banquet-halls-nbq6ctgpje.jpg',
    alt: 'Luxurious banquet hall interior with golden chandeliers at 7 Vachan Patna',
  },
  {
    src: 'https://content.jdmagicbox.com/v2/comp/patna/z3/0612px612.x612.250508092933.e8z3/catalogue/7-vachan-judges-colony-patna-banquet-halls-xxlkm18nj1.jpg',
    alt: '7 Vachan lobby with marble floors and chandeliers — Judges Colony Patna',
  },
];
    ...
    <div className="min-h-screen bg-[#FFFAF5]">
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src={GALLERY[0].src}
            alt="7 Vachan — Banquet Hall & Wedding Venue in Judges Colony, Patna"
            fill
          ...
          <div
            ...
            style={{ background: 'linear-gradient(120deg, rgba(10,5,2,0.92) 0%, rgba(10,5,2,0.58) 55%, rgba(10,5,2,0.85) 100%)' }}
          />
        </div>
        ...
        <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 sm:px-8 py-4">
          ...
          >
            <Phone className="w-3.5 h-3.5" /> {SHAADI_PHONE_DISPLAY}
          </a>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-white/70 text-base sm:text-lg leading-relaxed mb-6 max-w-lg">
                Patna&apos;s trusted banquet hall in Judges Colony, Saguna Mor — rated 4.6★ across 55 reviews. Weddings, receptions, birthdays, engagements &amp; corporate events with in-house catering and DJ.
              </p>
              ...
              <div className="flex items-center gap-3 mb-7">
                <div className="flex items-center gap-1">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <Star
                      key={s}
                      className={`w-4 h-4 ${s <= 4 ? 'fill-[#C5A46D] text-[#C5A46D]' : 'fill-[#C5A46D]/40 text-[#C5A46D]/40'}`}
                    />
                  ))}
                </div>
                <span className="text-white/60 text-sm">4.6 · 55 Ratings · 10 Years in Business</span>
              </div>
      ...
      {/* ── GALLERY ── */}
      <section className="bg-[#1C0A12] py-10 sm:py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[#C5A46D] text-[0.65rem] font-bold uppercase tracking-[0.2em] mb-6 text-center">Gallery</p>
      ...
      <section className="bg-[#2A1F1B] py-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-6 text-center">
            {[
              { value: '4.6★', label: '55 Customer Ratings' },
              { value: '10 Yrs', label: 'In Business' },
              { value: '9AM–10PM', label: 'Open 7 Days' },
            ].map(({ value, label }) => (
              <div key={label}>
                <p
      ...
      <section className="bg-[#FFFAF5] py-14 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm mt-2">Includes hall, décor &amp; in-house catering. Final price depends on guest count &amp; menu.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <p className="text-3xl font-bold text-[#8B1A4A] mt-1 mb-4">
                  ₹{pkg.price.toLocaleString('en-IN')}
                  <span className="text-sm text-gray-400 font-normal"> / plate</span>
                </p>
          ...
          <p className="text-center text-xs text-gray-400 mt-6">
            Prices are indicative. Contact us for exact pricing based on your guest count and menu preferences.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-playfair, serif)' }}
              >
                Conveniently Located at Saguna Mor, Patna
              </h2>
              <div className="flex items-start gap-3 text-gray-600 text-sm mb-3">
                <MapPin className="w-4 h-4 text-[#C5A46D] flex-shrink-0 mt-0.5" />
                <span>Near Fashion Factory Godawari Complex, Opposite Purise Hospital, Saguna Mor, Danapur Khagaul Road, Judges Colony, Patna – 801503</span>
              </div>
            ...
            <div className="rounded-2xl overflow-hidden border border-[#C5A46D]/20 shadow-lg">
              <iframe
                title="7 Vachan Location — Judges Colony Saguna Mor Patna"
                src="https://maps.google.com/maps?q=7+Vachan+Judges+Colony+Saguna+Mor+Patna&output=embed&z=15"
                width="100%"
                height="280"
