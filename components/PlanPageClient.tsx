...
import { User, Phone, Mail, Calendar, Users, UtensilsCrossed, Building2, CheckCircle, ChevronRight, ChevronLeft, Sparkles, Heart, Clock, X } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input required type="tel" value={form.phone} onChange={(e) => updateField('phone', e.target.value)} className="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-3 text-sm focus:border-amber-400 transition-colors" placeholder="+91 98765 43210" />
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="number" min="10" value={form.guestCount} onChange={(e) => updateField('guestCount', Number(e.target.value))} className="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-3 text-sm focus:border-amber-400 transition-colors" placeholder="200" />
                    </div>
                  </div>
                </div>
